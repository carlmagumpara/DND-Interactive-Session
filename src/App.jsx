...
function App() {
  ...
  const status = ['Undone', 'Ongoing', 'Done'];
    ...
    <>
      <Container className="mt-5">
        <Row>
          {status.map(_item => (
          <Col>
            <p className="text-center">{_item} Todos ({todos.filter(item => item.status === _item).length})</p>
            <div
              ...
              onDrop={e => {
                ...
                _todos[selected_todo_index].status = _item;
                setTodos(_todos);
              }}
              onDragOver={e => {
            ...
            >
              <ListGroup className="w-100">
                {todos.filter(item => item.status === _item).map(item => (
                  <ListGroup.Item
                    draggable
                    onDragStart={e => {
